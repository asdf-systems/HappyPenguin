...
public class GUIManager : GUIStatics {
	...
	private MenuC buttonC;
	private MenuE buttonE;
	private MenuQ buttonQ;
	private MenuY buttonY;
	...
	private void loadButtons(){
		...
		buttonC = gameObject.GetComponentInChildren<MenuC>();
		buttonY = gameObject.GetComponentInChildren<MenuY>();
		buttonQ = gameObject.GetComponentInChildren<MenuQ>();
		buttonE = gameObject.GetComponentInChildren<MenuE>();
