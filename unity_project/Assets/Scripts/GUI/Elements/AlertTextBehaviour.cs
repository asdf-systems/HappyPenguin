...
public class AlertTextBehaviour : UIElementBehaviour<GUIManager> {
	...
	private int myTextWidth = 200;
	private int myTextHeight = 50;
	...
	protected override void showElements(){
		if(textShow){
			...
			GeneralScreenGUI.Box(guiStatics, new Rect (x - myTextWidth/2,y - myTextHeight*5,myTextWidth,myTextHeight), text, inactiveStyle);
		}
	}
